...
class setting_config:
    ...
    model_config = {
        ...
        # ----- VM-UNet ----- #
        'depths': [2,2,4,2],
        'depths_decoder': [4,2,2],
        'drop_path_rate': 0.2,
        'load_ckpt_path': '/data/ldz/graduate/VM-UNet/pre_trained_weights/vmamba_small_e238_ema.pth',
    }

    datasets = 'crack' 
    data_path = '/data/ldz/crack_1730/'
    ...
    if opt == 'Adadelta':
        ...
        lr = 5e-7 # default: 1e-3 – learning rate
        betas = (0.9, 0.999) # default: (0.9, 0.999) – coefficients used for computing running averages of gradient and its square
        eps = 1e-8 # default: 1e-8 – term added to the denominator to improve numerical stability
    ...
    if sch == 'StepLR':
        ...
        T_max = 25 # – Maximum number of iterations. Cosine function period.
        eta_min = 5e-5 # – Minimum learning rate. Default: 0.
        last_epoch = -1 # – The index of last epoch. Default: -1.  
